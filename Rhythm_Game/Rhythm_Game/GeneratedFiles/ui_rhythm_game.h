...
public:
    ...
    void setupUi(QMainWindow *Rhythm_GameClass)
    {
        ...
        start_button->setGeometry(QRect(440, 310, 400, 80));
        ...
        quit_button->setGeometry(QRect(650, 580, 400, 80));
        ...
        label_2->setGeometry(QRect(170, 40, 201, 41));
        label_3 = new QLabel(main_widget);
        label_3->setObjectName(QStringLiteral("label_3"));
        label_3->setGeometry(QRect(420, 31, 151, 41));
        label_4 = new QLabel(main_widget);
        label_4->setObjectName(QStringLiteral("label_4"));
        label_4->setGeometry(QRect(610, 31, 141, 31));
        label_5 = new QLabel(main_widget);
        label_5->setObjectName(QStringLiteral("label_5"));
        label_5->setGeometry(QRect(280, 90, 371, 51));
        label_6 = new QLabel(main_widget);
        label_6->setObjectName(QStringLiteral("label_6"));
        label_6->setGeometry(QRect(280, 180, 221, 31));
    ...
    void retranslateUi(QMainWindow *Rhythm_GameClass)
    {
        ...
        label_2->setText(QApplication::translate("Rhythm_GameClass", "hihihi", 0));
        label_3->setText(QApplication::translate("Rhythm_GameClass", "XXXXX", 0));
        label_4->setText(QApplication::translate("Rhythm_GameClass", "YYYY", 0));
        label_5->setText(QApplication::translate("Rhythm_GameClass", "button nooooooooooooooot press!!!!", 0));
        label_6->setText(QApplication::translate("Rhythm_GameClass", "TextLabel", 0));
