...
public:
    ...
    void setupUi(QMainWindow *Rhythm_GameClass)
    {
        ...
        apple->setGeometry(QRect(20, 20, 300, 300));
        ...
        bus->setGeometry(QRect(340, 20, 300, 300));
        ...
        cat->setGeometry(QRect(660, 20, 300, 300));
        ...
        duck->setGeometry(QRect(980, 20, 300, 300));
        ...
        QObject::connect(quit_button, SIGNAL(clicked()), Rhythm_GameClass, SLOT(exit_button()));
